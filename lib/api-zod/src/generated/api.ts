...
export const GetScannerResultsQueryParams = zod.object({
  "granularity": zod.coerce.number().default(getScannerResultsQueryGranularityDefault)
})

export const GetScannerResultsResponse = zod.object({
  "scannedAt": zod.number(),
